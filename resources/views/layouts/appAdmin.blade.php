...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
     ...
     <img class="image rounded-circle" src="/admin/user/upload" alt="profile_image" style="width: 80px;height: 80px; padding: 10px; margin: 0px; ">
...
<!-- AdminLTE App -->
<script src="<?php echo asset('assets/dist/js/adminlte.min.js'); ?>"></script>
